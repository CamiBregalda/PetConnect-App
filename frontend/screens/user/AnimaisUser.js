              ...
              filteredAdopted.map(animal => (
                <View key={animal.id} style={styles.itemBox}>
                  ...
                  <View style={styles.itemRow}>
                    ...
                    <TouchableOpacity
                      onPress={() => navigation.navigate('AtualizarAnimal', { userId, animalId: animal.id })}
                    >
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#f1f1f1', paddingTop: 10 },
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#f1f1f1' },
  errorContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20, backgroundColor: '#f1f1f1' },
  searchContainer: {
    flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, marginBottom: 16,
  },
  filterIcon: { width: 28, height: 28, marginRight: 12 },
  searchBox: {
    flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 10, paddingHorizontal: 10, height: 40,
  },
  input: { flex: 1, fontSize: 14 },
  searchIcon: { width: 20, height: 20, tintColor: '#888' },
  sectionBox: {
    backgroundColor: '#fdfdfd', marginHorizontal: 16, marginBottom: 20, padding: 16, borderRadius: 10,
  },
  ...
  notFoundText: { marginTop: 10, color: '#666', fontStyle: 'italic', textAlign: 'center', width: '100%' },
